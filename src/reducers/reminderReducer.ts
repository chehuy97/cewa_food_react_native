...
export const reminderActionTypes = {
  ...
  REMOVE_APPEARED_REMINDER: 'REMOVE_APPEARED_REMINDER',
...
const reducer = (
  ...
  switch (action.type) {
    ...
    case reminderActionTypes.REMOVE_APPEARED_REMINDER:
      ...
      return {...state, reminders: action.payload.reminders};
    case reminderActionTypes.UPDATE_REMINDER:
      ...
      return {
        ...
        reminders: state.reminders.map(reminder =>
          reminder.reminder_id == newReminder.reminder_id
            ? {...reminder, note: newReminder.note, time: newReminder.time}
            : reminder,
        ),
      };
    case reminderActionTypes.REMOVE_REMINDER:
      ...
      return {
        ...
        reminders: state.reminders.filter(
          reminder => reminder.reminder_id != id,
        ),
      };
